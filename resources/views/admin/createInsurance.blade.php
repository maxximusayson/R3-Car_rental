            ...
            <div class="md:w-2/3 w-5/6 md:px-24 px-4 pb-8 mx-auto mt-2 space-y-12 bg-white border-2 border-gray-600 rounded-md">
                ...
                <div class="flex items-center justify-center gap-x-6 mb-6">
                    <a href="{{route('insurances.index')}}"
                        class="text-sm font-semibold leading-6 text-center text-blue-500 border-2 border-blue-500 p-1 w-20 rounded-md hover:bg-blue bg-sec-300">Cancel</a>
                    <button type="submit"
                        class="w-1/3 rounded-md px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-custom-hover-color focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-custom-color"
                        style="background-color: #3B8CBF;">
                        Save
                    </button>
                </div>
