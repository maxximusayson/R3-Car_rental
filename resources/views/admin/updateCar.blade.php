...
@section('content')
    ...
    <label for="video">Car Video (optional)</label>
    <input type="file" class="form-control" id="video" name="video" accept="video/*">
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <textarea name="description" id="description" rows="4"
                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-pr-400 sm:text-sm sm:leading-6">{{ $car->description }}</textarea>
                            </div>
                            @error('description')
                                <span class="text-red-500">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input type="text" name="branch" id="branch" value="{{ $car->branch }}"
                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-pr-400 sm:text-sm sm:leading-6">
                            </div>
                            @error('branch')
                                <span class="text-red-500">{{ $message }}</span>
